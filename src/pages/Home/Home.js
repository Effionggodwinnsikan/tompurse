    ...
    <div className="home-page">
        ...
        <div className="section-2-card">
          ...
          <div className="card2">
            ...
            <div className="card2-text">
              ...
              <p>
                Set aside the leftover change from everyday purchases turning on
                automatic Round-Ups.
              </p>
            </div>
          </div>
      ...
      <div className="section3">
        ...
        <div className="section3-text">
          <h5>Security that's strong as oak</h5>
          <p>
          ...
          <p className="p1">
            Our Company non pretium eget etiam tempus. Vitae sollicitudin in
            vulputate montes,
          </p>
        </div>
      </div>
