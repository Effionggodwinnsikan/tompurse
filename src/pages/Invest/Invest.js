    ...
    <div className="invest-section">
      ...
      <div className="invest-1">
        <div className="invest-1a">
         <h6>Basic Plan</h6>
          <p>
            ...
            platform to cater for your basic needs within the shortest 
            time frame (2 months) with a risk free return of 7% on your principal.
            With this plan, you can ably save for your upcoming expenses and
            the same time make some earnings on them with a minimum of 5000NGN.
          </p>
        </div>
       ...
       <div className="savings">
         <h6>
         Your subscription to this plan would help you meet those needs such as;
         </h6>
